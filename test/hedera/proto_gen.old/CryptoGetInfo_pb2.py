...
_CRYPTOGETINFOQUERY.fields_by_name['header'].message_type = QueryHeader__pb2._QUERYHEADER
_CRYPTOGETINFOQUERY.fields_by_name['accountID'].message_type = BasicTypes__pb2._ACCOUNTID
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.fields_by_name['accountID'].message_type = BasicTypes__pb2._ACCOUNTID
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.fields_by_name['proxyAccountID'].message_type = BasicTypes__pb2._ACCOUNTID
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.fields_by_name['key'].message_type = BasicTypes__pb2._KEY
...
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.fields_by_name['liveHashes'].message_type = CryptoAddLiveHash__pb2._LIVEHASH
_CRYPTOGETINFORESPONSE_ACCOUNTINFO.containing_type = _CRYPTOGETINFORESPONSE
_CRYPTOGETINFORESPONSE.fields_by_name['header'].message_type = ResponseHeader__pb2._RESPONSEHEADER
