...
_CRYPTODELETETRANSACTIONBODY.fields_by_name['transferAccountID'].message_type = BasicTypes__pb2._ACCOUNTID
_CRYPTODELETETRANSACTIONBODY.fields_by_name['deleteAccountID'].message_type = BasicTypes__pb2._ACCOUNTID
