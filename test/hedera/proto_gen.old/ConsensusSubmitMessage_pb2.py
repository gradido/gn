...
_CONSENSUSMESSAGECHUNKINFO.fields_by_name['initialTransactionID'].message_type = BasicTypes__pb2._TRANSACTIONID
_CONSENSUSSUBMITMESSAGETRANSACTIONBODY.fields_by_name['topicID'].message_type = BasicTypes__pb2._TOPICID
...
ConsensusMessageChunkInfo = _reflection.GeneratedProtocolMessageType('ConsensusMessageChunkInfo', (_message.Message,), {
  ...
  '__module__' : 'ConsensusSubmitMessage_pb2'
