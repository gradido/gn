...
_CONSENSUSTOPICINFO.fields_by_name['adminKey'].message_type = BasicTypes__pb2._KEY
_CONSENSUSTOPICINFO.fields_by_name['submitKey'].message_type = BasicTypes__pb2._KEY
_CONSENSUSTOPICINFO.fields_by_name['autoRenewPeriod'].message_type = Duration__pb2._DURATION
_CONSENSUSTOPICINFO.fields_by_name['autoRenewAccount'].message_type = BasicTypes__pb2._ACCOUNTID
...
ConsensusTopicInfo = _reflection.GeneratedProtocolMessageType('ConsensusTopicInfo', (_message.Message,), {
  ...
  '__module__' : 'ConsensusTopicInfo_pb2'
