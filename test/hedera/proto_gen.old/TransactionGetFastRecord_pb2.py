...
_TRANSACTIONGETFASTRECORDQUERY.fields_by_name['header'].message_type = QueryHeader__pb2._QUERYHEADER
_TRANSACTIONGETFASTRECORDQUERY.fields_by_name['transactionID'].message_type = BasicTypes__pb2._TRANSACTIONID
_TRANSACTIONGETFASTRECORDRESPONSE.fields_by_name['header'].message_type = ResponseHeader__pb2._RESPONSEHEADER
_TRANSACTIONGETFASTRECORDRESPONSE.fields_by_name['transactionRecord'].message_type = TransactionRecord__pb2._TRANSACTIONRECORD
...
TransactionGetFastRecordQuery = _reflection.GeneratedProtocolMessageType('TransactionGetFastRecordQuery', (_message.Message,), {
  ...
  '__module__' : 'TransactionGetFastRecord_pb2'
